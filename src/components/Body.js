...
const Body = () => {
  ...
  const fetchData = async () => {
      const Data = await fetch(
        "https://gobetween.oklabs.org/https://www.swiggy.com/dapi/restaurants/list/v5?lat=26.9195866&lng=75.7879608&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
      );
